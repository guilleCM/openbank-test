            ...
            <div className="App">
                <main className="App-content">
                    <Container>
                        ...
                        <ul>
                            <li>Tiene que estar maquetada semánticamente correcta, con etiquetas de HTML5 y layouts actuales.</li>
                        ...
                        <h3>Recursos</h3>
                        <p>Se provee un proyecto vacío donde se espera que el desarrollador complete la lógica. Ademas se provee de un base.scss con los colores corporativos e imágenes para completar los flujos. Todo esto es de libre disposición para que el destinatario lo use o no si lo cree conveniente.</p>
                        <h3>Duración</h3>
                        <p>No hay una estimación directa ni concreta de la prueba, pero queremos marcar como máximo 1 semana(7 días naturales) desde el recibo de la misma.</p>
